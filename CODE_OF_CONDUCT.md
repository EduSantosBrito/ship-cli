...
- **GitHub Security Advisories**: Use [private vulnerability reporting](https://github.com/EduSantosBrito/ship-cli/security/advisories/new) for sensitive matters
...
3. **Temporary Suspension**
   ...
   - Repair: Examples include respecting the spirit of the suspension, meeting the specified conditions for return.
